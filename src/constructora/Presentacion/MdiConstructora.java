 ...
 * @author Raul
 */
public class MdiConstructora extends javax.swing.JFrame {

    /**
     * Creates new form MdiConstructora
     */
    public MdiConstructora() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MdiConstructora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MdiConstructora().setVisible(true);
            }
        });
    }
